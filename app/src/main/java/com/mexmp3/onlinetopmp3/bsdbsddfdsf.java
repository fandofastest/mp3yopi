...
public class bsdbsddfdsf extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context context;
    List<Object> listOffline;
    ArrayList<Integer> count = new ArrayList<>();

    public bsdbsddfdsf(Context context, List<Object> listOffline) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        final kfgdfshhj trackoff = (kfgdfshhj)listOffline.get(position);
        ...
        offlineViewHolder.listArea.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, jtdgdsgsd.class);
